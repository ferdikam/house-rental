        ...
        <div class="modal" v-bind:class="showModal ? 'is-active' : ''">
            ...
            <div class="modal-card">
                <header class="modal-card-head">
                    <p class="modal-card-title">Enregistrer une commune</p>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState({
                communeStore: state => state.communeStore
            })
        },
        methods: {
            handleShowModal() {
            ...
            handleSubmit () {
                this.loading = true
                this.$store.dispatch('addCommuneObject', {name: this.name}).then((response) => {
                    this.loading = false
                    this.name = '';
